...
Skybox::Skybox(GLfloat const vertices[], std::vector<string>& faces)
{
...
GLuint Skybox::LoadCubemap(std::vector<string>& faces)
{
	GLuint textureID;
...
void Skybox::Draw(Shader* shader, glm::mat4 const& view, glm::mat4 const& projection)
{
